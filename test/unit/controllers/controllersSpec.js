...
describe('test PlayerController', function(){
    ...
    function rightHttpResponse() {
        httpBackend.whenGET('/jsonapi/mobile_paths')
        .respond([{
          ...
          "path_id": 7520056,
          "purchased": false, "number_of_problems": 4,
          ...
          "price": 0.0,
          "free": true, "number_of_problemsets": 6,
          "path_id": 12605566, "purchased": false,
          ...
          "name": "Beginner Ruby", "price": 0.0,
          "free": true,
          "number_of_problemsets": 6,
          "path_id": 8277128,
          "purchased": false, "number_of_problems": 73,
          "number_of_solved_problems": 1, "description":
          "Beginner Ruby Path"
        }, {
          "pathModified":
          "2012-08-29 02:53:32.616533",
          "name": "Beginner Java",
          "price": 0.0, "free": true,
          "number_of_problemsets": 6,
          "path_id": 8113761, "purchased":
          false, "number_of_problems": 65,
    ...
    it('should test function checkCreateTournLogin return true',function(){
        scope.player.nickname = 'nick';
        scope.checkCreateTournLogin();
        expect(typeof scope.player.nickname).not.toEqual('undefined');
        expect(scope.path).toEqual('mytournaments');
    });

    it('should test function checkCreateTournLogin return false',function(){
        scope.checkCreateTournLogin();
        expect(typeof scope.player.nickname).toEqual('undefined');
    });

    it('should test function checkJoinTournLogin return true',function(){
        scope.player.nickname = 'nick';
        scope.checkJoinTournLogin();
        expect(typeof scope.player.nickname).not.toEqual('undefined');
        expect(scope.path).toEqual('tournament-grpjoin');
    });

    it('should test function checkJoinTournLogin return false',function(){
        scope.checkJoinTournLogin();
        expect(typeof scope.player.nickname).toEqual('undefined');
    });
